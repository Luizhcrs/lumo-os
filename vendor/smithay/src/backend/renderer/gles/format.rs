...
pub const fn fourcc_to_gl_formats(value: Fourcc) -> Option<(GLenum, GLenum, GLenum)> {
    ...
    match value {
        Fourcc::Abgr8888 => Some((ffi::SRGB8_ALPHA8, ffi::RGBA, ffi::UNSIGNED_BYTE)),
...
pub const fn gl_internal_format_to_fourcc(format: GLenum) -> Option<Fourcc> {
    match format {
        ffi::RGBA | ffi::RGBA8 | ffi::SRGB8_ALPHA8 => Some(Fourcc::Abgr8888),
...
pub const fn gl_read_for_internal(format: GLenum) -> Option<(GLenum, GLenum)> {
    match format {
        ffi::RGBA | ffi::RGBA8 | ffi::SRGB8_ALPHA8 => Some((ffi::RGBA, ffi::UNSIGNED_BYTE)),
